...
echo "  2. Or manually deploy API/Web: ./scripts/deploy-blue-green.sh <VERSION> <REGISTRY>"
echo "  3. Or manually restart flow_serve: ./scripts/restart-flow-serve.sh <VERSION> <REGISTRY>"
echo ""
